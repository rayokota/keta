...
public class BailisAnomaliesTest {
    ...
    private byte[] dataValue1 = new byte[]{10};
    private byte[] dataValue2 = new byte[]{20};
    private byte[] dataValue3 = new byte[]{30};
    ...
    public void testSIPreventsLostUpdates() throws Exception {
        ...
        KetsieTransaction.setCurrentTransaction((KetsieTransaction) tx1);
        versionedCache.replace(rowId1, dataValue1, new byte[]{11});
    ...
    public void testSIPreventsReadSkew() throws Exception {
        ...
        KetsieTransaction.setCurrentTransaction((KetsieTransaction) tx2);
        versionedCache.replace(rowId1, dataValue1, new byte[]{12});

        // 5) update test set value = 18 where id = 2; -- T2
        KetsieTransaction.setCurrentTransaction((KetsieTransaction) tx2);
        versionedCache.replace(rowId2, dataValue2, new byte[]{18});
    ...
    public void testSIDoesNotPreventWriteSkew() throws Exception {
        ...
        KetsieTransaction.setCurrentTransaction((KetsieTransaction) tx2);
        versionedCache.replace(rowId2, dataValue2, new byte[]{21});
    ...
    public void testSIDoesNotPreventAntiDependencyCycles() throws Exception {
        ...
        KetsieTransaction.setCurrentTransaction((KetsieTransaction) tx2);
        versionedCache.put("row4".getBytes(), new byte[]{42});
