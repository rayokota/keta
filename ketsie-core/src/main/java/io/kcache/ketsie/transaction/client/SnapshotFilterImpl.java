...
import io.kcache.ketsie.transaction.client.KetsieTransactionManager.CommitTimestampLocatorImpl;
...
public class SnapshotFilterImpl implements SnapshotFilter {
     ...
     */
    public CommitTimestamp locateCellCommitTimestamp(KetsieTransaction transaction, long cellStartTimestamp,
    ...
    public Optional<Long> tryToLocateCellCommitTimestamp(KetsieTransaction transaction,
        ...
        CommitTimestamp tentativeCommitTimestamp =
            locateCellCommitTimestamp(transaction, cell.value.getVersion(),
                new CommitTimestampLocatorImpl(new KetsieCellId(versionedCache, cell.key, cell.value.getVersion()),
    ...
    private Optional<Long> getCommitTimestamp(KetsieTransaction transaction, KeyValue<byte[], VersionedValue> kv,
    ...
    public Optional<Long> getTSIfInTransaction(KetsieTransaction transaction,
    ...
    public Optional<Long> getTSIfInSnapshot(KetsieTransaction transaction,
                                            KeyValue<byte[], VersionedValue> kv,
                                            Map<Long, Long> commitCache)
        throws IOException {
    ...
    public List<VersionedValue> filterCellsForSnapshot(
        KetsieTransaction transaction, byte[] key, List<VersionedValue> rawCells) throws IOException {
    ...
    @Override
    public List<VersionedValue> get(KetsieTransaction transaction, byte[] key) {
        try {
    ...
    @Override
    public KeyValueIterator<byte[], List<VersionedValue>> all(KetsieTransaction transaction) {
        return new FilteredKeyValueIterator(transaction, versionedCache.all(0, Long.MAX_VALUE));
    }

    @VisibleForTesting
    public boolean isCommitted(KetsieTransaction transaction, KetsieCellId cellId) throws TransactionException {
        try {
