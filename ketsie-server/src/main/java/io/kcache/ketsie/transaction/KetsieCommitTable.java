...
public class KetsieCommitTable implements CommitTable {

    private static final Logger LOG = LoggerFactory.getLogger(KetsieCommitTable.class);

    private static final long LOW_WATERMARK_KEY = 0L;

    private final Cache<Long, Long> cache;

    public KetsieCommitTable(Cache<Long, Long> cache) {
        this.cache = cache;
    }
