...
public class KetsieSyncPostCommitter implements PostCommitActions {

    private static final Logger LOG = LoggerFactory.getLogger(KetsieSyncPostCommitter.class);

    private final CommitTable.Client commitTableClient;

    public KetsieSyncPostCommitter(CommitTable.Client commitTableClient) {
