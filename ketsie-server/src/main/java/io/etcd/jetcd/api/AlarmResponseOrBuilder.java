...
public interface AlarmResponseOrBuilder extends
   ...
   */
  java.util.List<io.etcd.jetcd.api.AlarmMember> 
      getAlarmsList();
  /**
   * <pre>
   * alarms is a list of alarms associated with the alarm request.
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  io.etcd.jetcd.api.AlarmMember getAlarms(int index);
  /**
   * <pre>
   * alarms is a list of alarms associated with the alarm request.
   * </pre>
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  java.util.List<? extends io.etcd.jetcd.api.AlarmMemberOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  io.etcd.jetcd.api.AlarmMemberOrBuilder getAlarmsOrBuilder(
      int index);
}
