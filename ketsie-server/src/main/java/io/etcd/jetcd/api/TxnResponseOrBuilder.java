...
public interface TxnResponseOrBuilder extends
   ...
   */
  java.util.List<io.etcd.jetcd.api.ResponseOp> 
      getResponsesList();
  /**
   * <pre>
   * responses is a list of responses corresponding to the results from applying
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  io.etcd.jetcd.api.ResponseOp getResponses(int index);
  /**
   * <pre>
   * responses is a list of responses corresponding to the results from applying
   * success if succeeded is true or failure if succeeded is false.
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  java.util.List<? extends io.etcd.jetcd.api.ResponseOpOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  io.etcd.jetcd.api.ResponseOpOrBuilder getResponsesOrBuilder(
      int index);
}
