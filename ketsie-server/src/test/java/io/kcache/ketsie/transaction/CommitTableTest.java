...
public class CommitTableTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(io.kcache.ketsie.transaction.CommitTableTest.class);

    @Test
    public void testBasicBehaviour() throws Throwable {
        Cache<Long, Long> cache = new InMemoryCache<>();
        KetsieCommitTable commitTable = new KetsieCommitTable(cache);
