...
public class KetaIdentity {
    ...
    public static KetaIdentity fromJson(String json) throws IOException {
        return new ObjectMapper().readValue(json, KetaIdentity.class);
    }

    public static KetaIdentity fromJson(ByteBuffer json) {
        try {
            byte[] jsonBytes = new byte[json.remaining()];
            json.get(jsonBytes);
            return new ObjectMapper().readValue(jsonBytes, KetaIdentity.class);
        } catch (IOException e) {
    ...
    public boolean equals(Object o) {
        ...
        KetaIdentity that = (KetaIdentity) o;
