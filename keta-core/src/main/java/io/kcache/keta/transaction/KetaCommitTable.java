...
public class KetaCommitTable implements CommitTable {

    private static final Logger LOG = LoggerFactory.getLogger(KetaCommitTable.class);

    private static final long LOW_WATERMARK_KEY = 0L;

    private final Cache<Long, Long> cache;

    public KetaCommitTable(Cache<Long, Long> cache) {
        this.cache = cache;
    }
    ...
    private class KetaWriter implements Writer {
    ...
    class KetaClient implements Client {
    ...
    public Writer getWriter() throws IOException {
        return new KetaWriter();
    }

    @Override
    public Client getClient() throws IOException {
        return new KetaClient();
    }
